	...
	<table width="1019" border="1" cellpadding="10" align="center" class="style16">
		<tr  >
			...
			<tr>
				...
				<td><input type="text" name="serprov" value="TATA INDICOM"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr class="style1"><td ><center><span class="style1" >TATA INDICOM Prepaid Mobile Recharge
             </span></center></td></tr>
			 <tr><td height="30"></td></tr>
			 <tr><td><img src="tataindicom.gif"></img></td></tr>
			 <tr><td><br>
Recharging your prepaid Tata Indicom prepaid mobile just got easier. Instead of visiting a retailer and purchasing a Tata Indicom recharge card, you simply need to go online, log onto JustRechargeIt.com and recharge your Tata Indicom prepaid mobile instantly. JustRechargeIt.com is a 24 x 7 free mobile recharge station that will allow you to recharge your prepaid Tata Indicom mobile online without leaving the comfort of your home or office, from anyplace and at anytime. 
 	 
Recharge / eTopUp your Tata Indicom mobile
Log into JustRechargeIt.com and register
Select your service provider "Tata Indicom" and location
Enter your prepaid Tata Indicom mobile number
Enter your recharge/etopup amount
Select the payment option (credit/debit/cash cards or netbanking account)
Click on the recharge button to recharge your prepaid Tata Indicom mobile number
<br>
Within seconds, you will receive a message from Tata Indicom on your Tata Indicom mobile number, informing you of your new balance status.
<br>
Recharge your Tata Indicom mobile NOW!!
			 </td>	</tr>
		  		 </td>
		</tr></table>
  </table>
