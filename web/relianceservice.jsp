	...
	<table width="1019" border="1" cellpadding="10" align="center" class="style16">
		<tr  >
			...
			<tr>
				...
				<td><input type="text" name="serprov" value="RELIANCE"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr class="style1"><td ><center><span class="style1" >RELIANCE Prepaid Mobile Recharge
             </span></center></td></tr>
			 <tr><td height="30"></td></tr>
			 <tr><td><img src="reliance.gif"></img></td></tr>
			 <tr><td><br>
Is recharging your prepaid MTS mobile a big hassle? Talk time rapidly depleting but have no time to visit the nearest retail outlet to refill your MTS mobile phone? No Worries! Now you can recharge your prepaid MTS mobile anytime and anywhere.

Balance a little low? Recharge your prepaid Reliance mobile (GSM and CDMA) instantly without leaving the comfort of your home, anytime and anywhere. Visit justrechargeit.com, a 24 x 7 free mobile recharge station and recharge your Reliance prepaid mobile online. We provide recharge for Reliance GSM mobile as well as Reliance CDMA mobile.

Now recharging your Reliance prepaid mobile number is just three steps. All you need to do is REGISTER with us, SELECT THE AMOUNT with which you want to recharge your Reliance prepaid mobile (GSM and CDMA) and PAY with your credit/debit/cash card or netbanking account. 
<br>
As soon as your payment is confirmed, the recharge to your Reliance prepaid mobile number happens instantly. Within seconds, you will receive a message from Reliance Mobile informing you of your new balance status on your Reliance prepaid mobile number that you have recharged.
<br>
Recharge your prepaid Reliance mobile NOW!!
			 </td>	</tr>
		  		 </td>
		</tr></table>
  </table>
