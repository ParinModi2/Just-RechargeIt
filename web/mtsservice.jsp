...
<tr  >
			...
			<tr>
				...
				<td><input type="text" name="serprov" value="MTS"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr class="style1"><td ><center><span class="style1" >MTS Prepaid Mobile Recharge
             </span></center></td></tr>
			 <tr><td height="30"></td></tr>
			 <tr><td><img src="mts.gif"></img></td></tr>
			 <tr><td><br>
...
Just Log on to Justrechargeit.com, a 24 x 7 free mobile recharge facility and eTopUp or recharge your prepaid MTS mobile instantly. Recharge your MTS mobile online in just three simple steps: Register, Select Amount and Pay.
 	 
Recharge / eTopUp your MTS mobile<br>
Log into JustRechargeIt.com and register.br>
Select your service provider "MTS" and location
Enter your Prepaid MTS mobile number
Enter your recharge/etopup amount.<br>
Click on the recharge button to recharge your prepaid MTS mobile number
<br>
Within seconds, you will receive a message from MTS on your prepaid MTS mobile number, informing you of your new balance status.
<br>
Recharge your MTS mobile NOW!!
			 </td>	</tr>
		  		 </td>
		</tr></table>
  </table>
