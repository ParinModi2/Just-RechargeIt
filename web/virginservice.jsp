	...
	<table width="1019" border="1" cellpadding="10" align="center" class="style16">
		<tr  >
			...
			<tr>
				...
				<td><input type="text" name="serprov" value="VIRGIN"></td>
			</tr>
			...
			<tr>
				<td><input type="submit" name=b1 value="JUST RECHARGE IT" ></a></td>
			</tr>
			</table>
		  </td>
			 <td width="673" align="justify"><table border="0">
			 <tr class="style1"><td ><center><span class="style1" >VIRGIN Prepaid Mobile Recharge
             </span></center></td></tr>
			 <tr><td height="30"></td></tr>
			 <tr><td><img src="vergin.gif"></img></td></tr>
			 <tr><td><br>
Are you running out of balance on your Virgin prepaid mobile? Recharge your prepaid Virgin mobile (GSM and CDMA) instantly without leaving the comfort of your home, anytime and anywhere. Visit justrechargeit.com, a 24 x 7 free mobile recharge station and recharge your Virgin prepaid mobile online. We provide recharge for Virgin GSM mobile as well as Virgin CDMA mobile.

Now recharging your Virgin prepaid mobile number is just three steps. All you need to do is REGISTER with us, SELECT THE AMOUNT with which you want to recharge your Virgin prepaid mobile (GSM and CDMA) and PAY with your credit/debit/cash card or netbanking account. 
<br>
As soon as your payment is confirmed, the recharge to your Virgin prepaid mobile number happens instantly. Within seconds, you will receive a message from Virgin Mobile informing you of your new balance status on your Virgin prepaid mobile number that you have recharged.
<br>
Recharge your prepaid Virgin mobile NOW!!
			 </td>	</tr>
		  		 </td>
		</tr></table>
  </table>
