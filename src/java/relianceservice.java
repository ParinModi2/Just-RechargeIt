 ...
 * @author A-4
 */
@WebServlet(name="relianceservice", urlPatterns={"/relianceservice"})
public class relianceservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet relianceservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet relianceservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"RELIANCE\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >RELIANCE Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"reliance.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      ...
      out.write("\r\n");
      out.write("Balance a little low? Recharge your prepaid Reliance mobile (GSM and CDMA) instantly without leaving the comfort of your home, anytime and anywhere. Visit justrechargeit.com, a 24 x 7 free mobile recharge station and recharge your Reliance prepaid mobile online. We provide recharge for Reliance GSM mobile as well as Reliance CDMA mobile.\r\n");
      out.write("\r\n");
      out.write("Now recharging your Reliance prepaid mobile number is just three steps. All you need to do is REGISTER with us, SELECT THE AMOUNT with which you want to recharge your Reliance prepaid mobile (GSM and CDMA) and PAY with your credit/debit/cash card or netbanking account. \r\n");
      out.write("<br>\r\n");
      out.write("As soon as your payment is confirmed, the recharge to your Reliance prepaid mobile number happens instantly. Within seconds, you will receive a message from Reliance Mobile informing you of your new balance status on your Reliance prepaid mobile number that you have recharged.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your prepaid Reliance mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
