 ...
 * @author A-4
 */
@WebServlet(name="videoconservice", urlPatterns={"/videoconservice"})
public class videoconservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet videoconservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet videoconservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
              try{
