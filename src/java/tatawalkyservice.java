 ...
 * @author A-4
 */
@WebServlet(name="tatawalkyservice", urlPatterns={"/tatawalkyservice"})
public class tatawalkyservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet tatawalkyservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet tatawalkyservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"TATAWALKY\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >TATA WALKY Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"walky.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Recharging or Topping up your Tata Walky has never been easier. You dont have to look for a Talk Walky outlet or authorized dealer. You dont even have to step out of your house. All you need to do is log onto www.justrechargeit.com, register your Tata Walky mobile number, Enter the recharge amount.\r\n");
      out.write("<br>\r\n");
      out.write("\r\n");
      out.write("Justrechargeit is a 24 x 7 free mobile recharge station that enables you to recharge your Tata Walky prepaid mobile online. \r\n");
      out.write("<br> \t \r\n");
      out.write("Recharge / TopUp your Tata Walky\r\n");
      out.write("<br>Log into JustRechargeIt.com and register\r\n");
      out.write("<br>Select your service provider \"Tata Walky\" and location\r\n");
      out.write("<br>Enter your Tata Walky number\r\n");
      out.write("<br>Enter your recharge/etopup amount\r\n");
      out.write("<br>Select the payment option <br>\r\n");
      out.write("Click on the recharge button to recharge your Tata Walky mobile number\r\n");
      out.write("<br>\r\n");
      out.write("Within seconds, you will receive a message from Tata Walky on your Tata Walky number, informing you of your new balance status.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your Tata Walky NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
