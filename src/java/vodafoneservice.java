 ...
 * @author A-4
 */
@WebServlet(name="vodafoneservice", urlPatterns={"/vodafoneservice"})
public class vodafoneservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet vodafoneservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet vodafoneservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"VODAFONE\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td><center><span class=\"style1\" >VODAFONE Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t \t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t <tr><td><img src=\"vodafone.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Talk time rapidly depleting, no time to visit the nearest retail outlet to refill your prepaid Vodafone mobile phone? Not to worry coz now you can recharge your Vodafone prepaid mobile instantly by registering with JustRechargeIt.com. We provide the fastest and the easiest online mobile recharge solution.\r\n");
      out.write("\r\n");
      out.write("Just Log on to JustRechargeIt.com anytime and from anywhere and eTopUp or recharge your prepaid Vodafone mobile instantly is simple steps: Register, Select Amount and Pay. JustRechargeIt.com is a 24 x 7 free online mobile recharge facility.\r\n");
      out.write(" \t \r\n");
      out.write("Recharge / eTopUp your Uninor mobile\r\n");
      out.write("Log into JustRechargeIt.com and register\r\n");
      out.write("Select your service provider \"Vodafone\" and location\r\n");
      out.write("Enter your prepaid Vodafone mobile number\r\n");
      out.write("Enter your recharge/etopup amount\r\n");
      out.write("\r\n");
      out.write("Click on the recharge button to recharge your Vodafone mobile number\r\n");
      out.write("<br>\r\n");
      out.write("As soon as your payment is confirmed, the recharge to your Vodafone prepaid mobile number happens instantly. Within seconds, you will receive a message from Vodafone informing you of your new balance status on your Vodafone prepaid mobile number that you have recharged.\r\n");
      out.write("\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
