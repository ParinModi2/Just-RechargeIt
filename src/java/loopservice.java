 ...
 * @author A-4
 */
@WebServlet(name="loopservice", urlPatterns={"/loopservice"})
public class loopservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet loopservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet loopservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
              try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"LOOP\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >Loop Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"loop.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Is your talktime over? Are you thinking of going to the retail outlet to get the Loop mobile recharge coupon? Well, what if you could recharge your prepaid Loop mobile instantly without leaving the comfort of your home or office? Sounds goodVisit JustRechargeIt.com, a 24 x 7 free mobile recharge station and recharge your prepaid Loop mobile online within minutes. \r\n");
      out.write(" \t<br> \r\n");
      out.write("Recharge / eTopUp your Loop mobile<br>\r\n");
      out.write("Log into JustRechargeIt.com and register<br>\r\n");
      out.write("Select your service provider \"LOOP\" and location<br>\r\n");
      out.write("Enter your prepaid Loop mobile number<br>\r\n");
      out.write("Enter your recharge/etopup amount<br>\r\n");
      out.write("Select the payment option<br>\r\n");
      out.write("Click on the recharge button to recharge your prepaid Loop mobile number\r\n");
      out.write("<br>\r\n");
      out.write("Within seconds, you will receive a message from Loop informing you of your new balance status on your prepaid Loop mobile number.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your Loop Mobile NOW!!\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
      out.write("\r\n");
