 ...
 * @author A-4
 */
@WebServlet(name="bsnlservice", urlPatterns={"/bsnlservice"})
public class bsnlservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet bsnlservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet bsnlservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"BSNL\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >BSNL Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr> <td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"bsnl.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Do away with BSNL recharge cards and hassles such as locating a retail outlet to refill your quickly depleting BSNL prepaid mobile balance. Now, recharge your prepaid BSNL mobile instantly without leaving the comfort of your home. Visit justrechargeit.com, a 24 x 7 free online mobile recharge station. \r\n");
      out.write(" \t \r\n");
      out.write("Recharge / eTopUp your BSNL mobile number:\r\n");
      out.write("Log into JustRechargeIt.com and register\r\n");
      out.write("Select your service provider \"BSNL\" and location\r\n");
      out.write("Enter your prepaid BSNL mobile number\r\n");
      ...
      out.write("Click on the recharge button to recharge your prepaid BSNL mobile number\r\n");
      out.write("\r\n");
      out.write("Within seconds, you will receive a message from BSNL informing you of your new balance status on your registered BSNL prepaid mobile number. \r\n");
      out.write("\r\n");
      out.write("Recharge your BSNL mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
