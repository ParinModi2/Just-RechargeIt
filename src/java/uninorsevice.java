 ...
 * @author A-4
 */
@WebServlet(name="uninorsevice", urlPatterns={"/uninorsevice"})
public class uninorsevice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet uninorsevice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet uninorsevice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"UNINOR\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >UNINOR Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"uninor.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("If you are a Uninor user and recharging your prepaid Uninor mobile phone is a very tiring job then JustRechargeIt.com is the solution for you. Now you dont have to head to the nearest retail outlet to refill your mobile phone. You can recharge your prepaid Uninor mobile instantly with JustRechargeIt.com.\r\n");
      out.write("\r\n");
      out.write("Recharge your prepaid Uninor mobile instantly without leaving the comfort of your home, antime and anywhere. Visit JustRechargeIt.com, a 24 x 7 free mobile recharge station and follow these steps to recharge your Uninor prepaid mobile.\r\n");
      out.write(" \t \r\n");
      out.write("Recharge / eTopUp your Uninor mobile\r\n");
      out.write("Log into JustRechargeIt.com and register\r\n");
      out.write("Select your service provider \"Uninor\" and location\r\n");
      out.write("Enter your prepaid Uninor mobile number\r\n");
      ...
      out.write("Click on the recharge button to recharge your Uninor mobile number\r\n");
      out.write("<br>\r\n");
      out.write("Within seconds, you will receive a message from Uninor informing you of your new balance status on your registered Uninor prepaid mobile number.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your Uninor mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
