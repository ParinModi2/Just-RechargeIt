 ...
 * @author A-4
 */
@WebServlet(name="virginservice", urlPatterns={"/virginservice"})
public class virginservice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet virginservice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet virginservice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"VIRGIN\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td><input type=\"submit\" name=b1 value=\"JUST RECHARGE IT\" ></a></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t  </td>\r\n");
      out.write("\t\t\t <td width=\"673\" align=\"justify\"><table border=\"0\">\r\n");
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >VIRGIN Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"vergin.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Are you running out of balance on your Virgin prepaid mobile? Recharge your prepaid Virgin mobile (GSM and CDMA) instantly without leaving the comfort of your home, anytime and anywhere. Visit justrechargeit.com, a 24 x 7 free mobile recharge station and recharge your Virgin prepaid mobile online. We provide recharge for Virgin GSM mobile as well as Virgin CDMA mobile.\r\n");
      out.write("\r\n");
      out.write("Now recharging your Virgin prepaid mobile number is just three steps. All you need to do is REGISTER with us, SELECT THE AMOUNT with which you want to recharge your Virgin prepaid mobile (GSM and CDMA) and PAY with your credit/debit/cash card or netbanking account. \r\n");
      out.write("<br>\r\n");
      out.write("As soon as your payment is confirmed, the recharge to your Virgin prepaid mobile number happens instantly. Within seconds, you will receive a message from Virgin Mobile informing you of your new balance status on your Virgin prepaid mobile number that you have recharged.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your prepaid Virgin mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
