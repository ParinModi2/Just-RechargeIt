 ...
 * @author A-4
 */
@WebServlet(name="tataindicomser", urlPatterns={"/tataindicomser"})
public class tataindicomser extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet tataindicomser</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet tataindicomser at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
              try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"TATA INDICOM\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >TATA INDICOM Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"tataindicom.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Recharging your prepaid Tata Indicom prepaid mobile just got easier. Instead of visiting a retailer and purchasing a Tata Indicom recharge card, you simply need to go online, log onto JustRechargeIt.com and recharge your Tata Indicom prepaid mobile instantly. JustRechargeIt.com is a 24 x 7 free mobile recharge station that will allow you to recharge your prepaid Tata Indicom mobile online without leaving the comfort of your home or office, from anyplace and at anytime. \r\n");
      out.write(" \t \r\n");
      out.write("Recharge / eTopUp your Tata Indicom mobile\r\n");
      out.write("Log into JustRechargeIt.com and register\r\n");
      out.write("Select your service provider \"Tata Indicom\" and location\r\n");
      out.write("Enter your prepaid Tata Indicom mobile number\r\n");
      out.write("Enter your recharge/etopup amount\r\n");
      out.write("Select the payment option (credit/debit/cash cards or netbanking account)\r\n");
      out.write("Click on the recharge button to recharge your prepaid Tata Indicom mobile number\r\n");
      out.write("<br>\r\n");
      out.write("Within seconds, you will receive a message from Tata Indicom on your Tata Indicom mobile number, informing you of your new balance status.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your Tata Indicom mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
