 ...
 * @author A-4
 */
@WebServlet(name="mtnlsevice", urlPatterns={"/mtnlsevice"})
public class mtnlsevice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet mtnlsevice</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet mtnlsevice at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
             try{
   ...
   //  String ses12=(String)  chkses.getAttribute("sesvarmno");
    ...
    catch(Exception ex)
    {
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"serprov\" value=\"MTNL\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t <tr class=\"style1\"><td ><center><span class=\"style1\" >MTNL Prepaid Mobile Recharge\r\n");
      out.write("             </span></center></td></tr>\r\n");
      out.write("\t\t\t <tr><td height=\"30\"></td></tr>\r\n");
      out.write("\t\t\t <tr><td><img src=\"mtnl.gif\"></img></td></tr>\r\n");
      out.write("\t\t\t <tr><td><br>\r\n");
      out.write("Recharge your prepaid MTNL/Dolphin mobile without stepping out of your home or office. Visit JustRechargeIt.com, a 24 x 7 free mobile recharge station and recharge your prepaid MTNL mobile online. We provide the easiest and the fastest online recharge for your MTNL/Dolphin mobile. Recharge your MTNL prepaid mobile in three simple steps: Register, Select Amount and Pay.\r\n");
      out.write(" \t \r\n");
      out.write("Recharge / eTopUp your prepaid MTNL mobile\r\n");
      out.write("Log into JustRechargeIt.com and register\r\n");
      out.write("Select your service provider \"MTNL\" and location\r\n");
      out.write("Enter your prepaid MTNL/Dolphin mobile number\r\n");
      out.write("Enter your recharge/etopup amount\r\n");
      out.write("Select the payment option \r\n");
      out.write("Click on the recharge button to recharge your prepaid MTNL mobile number\r\n");
      out.write("<br>\r\n");
      out.write("Within seconds, you will receive a message from MTNL informing you of your new balance status on your MTNL mobile number.\r\n");
      out.write("<br>\r\n");
      out.write("Recharge your prepaid MTNL mobile NOW!!\r\n");
      out.write("\t\t\t </td>\t</tr>\r\n");
      out.write("\t\t  \t\t </td>\r\n");
      out.write("\t\t</tr></table>\r\n");
      out.write("  </table>\r\n");
