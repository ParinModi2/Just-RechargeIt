	...
	<table width="1019" border="1" cellpadding="10" align="center" class="style16">
		<tr  >
			...
			<tr>
				...
				<td><input type="text" name="serprov" value="UNINOR"></td>
			</tr>
			...
			<tr>
			 ...
			 <tr class="style1"><td ><center><span class="style1" >UNINOR Prepaid Mobile Recharge
             </span></center></td></tr>
			 <tr><td height="30"></td></tr>
			 <tr><td><img src="uninor.gif"></img></td></tr>
			 <tr><td><br>
If you are a Uninor user and recharging your prepaid Uninor mobile phone is a very tiring job then JustRechargeIt.com is the solution for you. Now you don’t have to head to the nearest retail outlet to refill your mobile phone. You can recharge your prepaid Uninor mobile instantly with JustRechargeIt.com.

Recharge your prepaid Uninor mobile instantly without leaving the comfort of your home, antime and anywhere. Visit JustRechargeIt.com, a 24 x 7 free mobile recharge station and follow these steps to recharge your Uninor prepaid mobile.
 	 
Recharge / eTopUp your Uninor mobile
Log into JustRechargeIt.com and register
Select your service provider "Uninor" and location
Enter your prepaid Uninor mobile number
Enter your recharge/etopup amount
Select the payment option (credit/debit/cash cards or netbanking account)
Click on the recharge button to recharge your Uninor mobile number
<br>
Within seconds, you will receive a message from Uninor informing you of your new balance status on your registered Uninor prepaid mobile number.
<br>
Recharge your Uninor mobile NOW!!
			 </td>	</tr>
		  		 </td>
		</tr></table>
  </table>
